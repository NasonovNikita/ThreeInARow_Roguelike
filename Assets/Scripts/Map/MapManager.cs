...
namespace Map
{
    public class MapManager : MonoBehaviour
    {
        ...
        private readonly List<List<Vertex>> _layeredVertexes = new();
        ...
        public void Awake()
        {
            ...
            {
                _layeredVertexes.Add(new List<Vertex>());
            ...
            {
                var oldLayer = _layeredVertexes[i];
                var newLayer = _layeredVertexes[i + 1];
